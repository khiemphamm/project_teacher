...
interface PhysicsQuestion extends Record<string, unknown> {
  id: string;
  question: string;
  type: 'MULTIPLE_CHOICE' | 'CALCULATION' | 'FORMULA' | 'DIAGRAM';
...
// Mock data
const mockQuestions: PhysicsQuestion[] = [
  {
    id: '1',
    question: 'Một vật rơi tự do từ độ cao 20m. Tính thời gian rơi.',
    type: 'CALCULATION',
    difficulty: 'MEDIUM',
    topic: 'Cơ học',
    points: 3,
...
const mockAssignments: Assignment[] = [
  {
    id: '1',
    title: 'Kiểm tra Cơ học',
    description: 'Bài kiểm tra về chuyển động và lực',
  ...
  {
    id: '2',
    title: 'Bài tập Điện học',
    description: 'Bài tập về dòng điện và điện trường',
...
export function PhysicsDashboard() {
  ...
  const questionColumns = [
    {
      key: 'question' as keyof PhysicsQuestion,
      header: 'Câu hỏi',
      cell: (value: unknown) => (
    ...
    {
      key: 'type' as keyof PhysicsQuestion,
      header: 'Loại',
      cell: (value: unknown) => {
        const typeMap = {
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Quản lý câu hỏi và bài tập Vật lý
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600">+18 tuần này</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-blue-600">2 sắp hết hạn</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-yellow-600">-0.2 so với tháng trước</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="questions" className="w-full">
          ...
          <TabsContent value="questions" className="space-y-6">
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle>Ngân hàng câu hỏi Vật lý</CardTitle>
          ...
          <TabsContent value="assignments" className="space-y-6">
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle>Bài tập Vật lý</CardTitle>
          ...
          <TabsContent value="analytics">
            <Card>
              <CardHeader>
                <CardTitle>Thống kê Vật lý</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select className="w-full px-3 py-2 border border-border rounded-md bg-background text-foreground">
                ...
                <option value="Nhiệt học">Nhiệt học</option>
